...
public class PeerSetMsg extends SimpleMsg{
	...
	public PeerSetMsg(int type, Neighbor []array, Node sender){
		//System.out.println("Le PeerSetMsg a été appelé pour le tracker "+sender.getID());
		//System.out.println("Voici le Neighbor array envoyé au node :");
		/*int i=0;

		while(array[i+1]!=null)
		{
			//System.out.println("Node #"+array[i].node.getID());
			i++;
		}
*/
		super.type = type;
